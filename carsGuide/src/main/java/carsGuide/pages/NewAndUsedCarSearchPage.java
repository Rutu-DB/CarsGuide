...
public class NewAndUsedCarSearchPage extends Utility {
    ...
    public void verifyUserIsOnNewAndUsedCarSearchPage() {
        Reporter.addStepLog("Verifies that User is on New & Used Car Search Page " + _verifySearchCarText.toString() + "<br>");
    ...
    public void selectAnyMakeDropdown(String brand) {
        Reporter.addStepLog("Clicks on Any Make Field " + _anyMakeField.toString() + "<br>");
    ...
    public void selectAnyModelDropdown(String model) {
        Reporter.addStepLog("This method selects Model" + _anyModel.toString() + "<br>");
    ...
    public void selectAnyLocationFromDropDown(String location) {
        Reporter.addStepLog("This method selects Location from DropDown " + _anyLocation.toString() + "<br>");
    ...
    public void selectPriceFromDropDown(String amount) {
        Reporter.addStepLog("This selects price " + _price.toString() + "<br>");
    ...
    public void clickOnFindMyNextCarButton() {
        Reporter.addStepLog("This clicks on Find My Next Car Button " + _findMyNextCarBtn.toString() + "<br>");
